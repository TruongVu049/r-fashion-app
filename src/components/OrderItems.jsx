...
const OrderItems = ({ items, status, onchaneOrderItemsRating, isLoading }) => {
        ...
        <section className="bg-white">
          <div className="container mx-auto p-4">
            <div className="animate-pulse">
              <div className="h-20  flex items-center justify-center mb-4 bg-gray-200 rounded-md "></div>
              <div className="h-20  flex items-center justify-center mb-4 bg-gray-200 rounded-md "></div>
              <div className="h-20  flex items-center justify-center  bg-gray-200 rounded-md "></div>
            </div>
          </div>
        </section>
      ) : (
